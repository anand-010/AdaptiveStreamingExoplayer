...
public class PlayerActivity extends AppCompatActivity implements View.OnClickListener, PlaybackPreparer, PlayerControlView.VisibilityListener {
    ...
    private ImageView resize_player;
...
// Activity lifecycle
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        resize_player = (ImageView)findViewById(R.id.resize_player);
...
//        tvPlayerEndTime = (TextView) findViewById(R.id.tv_player_end_time);
        imgSetting = (TextView) findViewById(R.id.img_setting);
        ...
        resize_player.setOnClickListener(this);
...
// Internal methods
    ...
    private void initializePlayer() {
        ...
        player = ExoPlayerFactory.newSimpleInstance(/* context= */ PlayerActivity.this, renderersFactory, trackSelector, defaultLoadControl);
        ...
        Log.i(TAG, "initializePlayer: the url got is"+movie_url);
        mediaSource = buildMediaSource(Uri.parse(movie_url));
